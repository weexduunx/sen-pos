                    ...
                    <div class="page-title">
                        <div class="col-12">
                            <a href="javascript:void(0);" class="btn btn-adds" data-bs-toggle="modal"
                                data-bs-target="#OpenCaisse"><i class="fa fa-plus me-2"></i>Ouvrir Caisse</a>
                        </div>
                        {{-- <h4>Categories</h4>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <li>
                                        <a href="pos.html#" class="dropdown-item">Action</a>
                                    </li>
                                    <li>
                                        <a href="pos.html#" class="dropdown-item">Another Action</a>
                                    </li>
                                    <li>
                                        <a href="pos.html#" class="dropdown-item">Something Elses</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
